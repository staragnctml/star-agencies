            ...
            <article class="product-card">
                ...
                <div class="product-info">
                    ...
                    <div class="product-actions">
                        <a href="https://wa.me/919447016013?text=${message}" target="_blank" rel="noopener" class="modern-wa-btn" style="display: flex; align-items: center; justify-content: center; text-decoration: none; border: 1px solid #e2e8f0; padding: 10px; border-radius: 50px; background: #f8fafc; margin-top: 15px; transition: 0.3s;">
